...
# 7 segment display
 set_property PACKAGE_PIN W7 [get_ports {seq[0]}]
    set_property IOSTANDARD LVCMOS33 [get_ports {seq[0]}]
 set_property PACKAGE_PIN W6 [get_ports {seq[1]}]
    set_property IOSTANDARD LVCMOS33 [get_ports {seq[1]}]
 set_property PACKAGE_PIN U8 [get_ports {seq[2]}]
    set_property IOSTANDARD LVCMOS33 [get_ports {seq[2]}]
 set_property PACKAGE_PIN V8 [get_ports {seq[3]}]
    set_property IOSTANDARD LVCMOS33 [get_ports {seq[3]}]
 set_property PACKAGE_PIN U5 [get_ports {seq[4]}]
    set_property IOSTANDARD LVCMOS33 [get_ports {seq[4]}]
 set_property PACKAGE_PIN V5 [get_ports {seq[5]}]
    set_property IOSTANDARD LVCMOS33 [get_ports {seq[5]}]
 set_property PACKAGE_PIN U7 [get_ports {seq[6]}]
    set_property IOSTANDARD LVCMOS33 [get_ports {seq[6]}]
